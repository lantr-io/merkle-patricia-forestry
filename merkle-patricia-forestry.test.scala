...
class MerklePatriciaTreeTest extends FunSuite {
    ...
    private implicit inline def toByteString(inline s: String): ByteString = ByteString.fromString(s)
   ...
   ╚═══════════════════════════════════════════════════════════════════╝
    ...
    test("idempotent update") {
        ...
        assertEquals(
          updatedTrie.update(banana.name, banana.proof, "🍆", "🍆"),
          updatedTrie,
...
object Fruits {
    ...
    /** Root hash when banana is mapped to 🍆 instead */
