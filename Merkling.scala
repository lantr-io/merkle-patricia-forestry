...
object Merkling:
    ...
    def sparseMerkle16(
        ...
        if me < 8 then
            if neighbor < 8 then combine(sparseMerkle8(me, meHash, neighbor, neighborHash), NullHash8)
            else
                combine(
    ...
    def sparseMerkle8(
        ...
        if me < 4 then
            if neighbor < 4 then combine(sparseMerkle4(me, meHash, neighbor, neighborHash), NullHash4)
            else
                combine(
